...
class GraphsStatisticViewController: UIViewController {
    ...
    extension GraphsStatisticViewController {
        func updateGraph () {
            ...
            //        for i in 0..<5 {
            //            let date4 = Date()
            //            let date3 = date4.addingTimeInterval(TimeInterval(Double(i) * 60.0))
            //            let value = ChartDataEntry(x: date3.timeIntervalSince1970, y: Double(i))
            //            lineChartEntry.append(value)
            //        }
            
            //        var startingDate = fromDateValue
            //        var expencesSortedByDays: [(date: Date, expenceCounted: Int32)] = []
            //
            //        while startingDate < toDateValue {
            //            var expenceListForDate = expensesList.filter{$0.epenceDate?.start(of: .day) == startingDate.start(of: .day)}
            ...
            //        for expence in expensesList {
            //            if let expenceDate = expence.epenceDate {
            //                let value = ChartDataEntry(x: expenceDate.timeIntervalSince1970 , y: Double(expence.price))
            //                lineChartEntry.append(value)
            //            }
            //        }
          ...
          //  let numberOfYValues = calculatedExpencesForDateRange.count > 10 ? 10 : calculatedExpencesForDateRange.count + 2
          //  yAxis.setLabelCount(numberOfYValues, force: true)
